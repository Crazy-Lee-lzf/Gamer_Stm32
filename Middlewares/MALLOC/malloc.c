...
static __align(32) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(0x20000000)));                           /* 内部DTCM内存池 */
...
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0X20000000 + MEM2_MAX_SIZE)));            /* 内部DTCM内存池MAP */
...
static __ALIGNED(32) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((section(".bss.ARM.__at_0X20000000")));    /* 内部DTCM内存池 */
...
/* 内存管理表 */
static MT_TYPE mem1mapbase[MEM1_ALLOC_TABLE_SIZE];                                                            /* 内部SRAM内存池MAP */
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((section(".bss.ARM.__at_0X2001E000")));       /* 内部DTCM内存池MAP */
